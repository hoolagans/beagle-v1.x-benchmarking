...
public class Program
{
	...
	//using var mlEngine = new MLEngine<DemoForMSU4, StdFitFunc>(forceCPUAccelerator: false);
        using var mlEngine = new MLEngine<EQ23, StdHyperFitFunc>(forceCPUAccelerator: false);
