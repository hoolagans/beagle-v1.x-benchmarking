...
//This is an equivalent of an internal class ModelBindingHelper from Mvc.Core
namespace Supermodel.Presentation.Mvc.ModelBinding
{
    ...
    {
        public static class SuperModelBindingHelper
        {
            /// <summary>
                ...
                Func<ModelMetadata, bool> propertyFilter)
            {
                ...
                {
                    var message = "FormatModelType_WrongType";
            ...
            private static object UnwrapPossibleArrayType(object value, Type destinationType, CultureInfo culture)
            {
                ...
                if (destinationType.IsArray)
                {
                    ...
                    if (destinationElementType == null) throw new NoNullAllowedException("destinationElementType == null");
            ...
            private static object ConvertSimpleType(object value, Type destinationType, CultureInfo culture)
            {
                ...
                if (!(canConvertFrom || converter.CanConvertTo(destinationType)))
                {
                    ...
                    throw new InvalidOperationException("FormatValueProviderResult_NoConverterExists");
                }
                ...
                try
                {
                    return canConvertFrom
                        ...
                        ? converter.ConvertFrom(null, culture, value) //It appears that the first param is not even used
